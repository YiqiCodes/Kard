  ...
  return (
    <>
      <>
        ...
        <WhichKardWrapper className="appbody">
          <div className="kard-border">
          {user ? <h5 className='mobile-nickname'>{user.nickname}</h5> : null}

            <KardSelectorContainer className="KardSelectorContainer">
              {/* album begins */}
              
                <KardCategoryOutterContainer className="album">
                ...
                {/* book begins */}
                <KardCategoryOutterContainer className="book">
                ...
                {/* movie begins */}
                <KardCategoryOutterContainer className="movie">
                ...
                {/* restaurent begins */}
                <KardCategoryOutterContainer className="restaurent">
              ...
              {user ? <h4 className='nickname'>{user.nickname}</h4> : null}
